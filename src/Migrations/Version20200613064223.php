 ...
 */
final class Version20200613064223 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_50159CA9DA6A219 ON projet');
        $this->addSql('ALTER TABLE projet DROP place_id, CHANGE projectadmin_id projectadmin_id INT DEFAULT NULL, CHANGE typeprojet_id typeprojet_id INT DEFAULT NULL, CHANGE adress_id adress_id INT DEFAULT NULL, CHANGE datedevis datedevis DATE DEFAULT NULL, CHANGE datefacture datefacture DATE DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE type_message_message (type_message_id INT NOT NULL, message_id INT NOT NULL, INDEX IDX_D1019E074E79C50C (type_message_id), INDEX IDX_D1019E07537A1329 (message_id), PRIMARY KEY(type_message_id, message_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
