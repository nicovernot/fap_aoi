 ...
 */
final class Version20200623082159 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE projet ADD surface INT DEFAULT NULL, CHANGE projectadmin_id projectadmin_id INT DEFAULT NULL, CHANGE typeprojet_id typeprojet_id INT DEFAULT NULL, CHANGE adress_id adress_id INT DEFAULT NULL, CHANGE datedevis datedevis DATE DEFAULT NULL, CHANGE datefacture datefacture DATE DEFAULT NULL, CHANGE place1 place1 VARCHAR(100) DEFAULT \'draft\' NOT NULL');
        $this->addSql('ALTER TABLE condition_place CHANGE place_id place_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE message CHANGE projet_id projet_id INT DEFAULT NULL, CHANGE destinataire_id destinataire_id INT DEFAULT NULL, CHANGE emeteur_id emeteur_id INT DEFAULT NULL, CHANGE typemessage_id typemessage_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE type_projet ADD contientsuraface TINYINT(1) NOT NULL, ADD priseencharge DOUBLE PRECISION NOT NULL, CHANGE familleprojet_id familleprojet_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE document CHANGE user_id user_id INT DEFAULT NULL, CHANGE conditionplace_id conditionplace_id INT DEFAULT NULL, CHANGE projet_id projet_id INT DEFAULT NULL, CHANGE fichier fichier VARCHAR(500) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE condition_place CHANGE place_id place_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE document CHANGE user_id user_id INT DEFAULT NULL, CHANGE conditionplace_id conditionplace_id INT DEFAULT NULL, CHANGE projet_id projet_id INT DEFAULT NULL, CHANGE fichier fichier VARCHAR(500) CHARACTER SET utf8 DEFAULT \'NULL\' COLLATE `utf8_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE place CHANGE typeprojet_id typeprojet_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE projet DROP surface, CHANGE projectadmin_id projectadmin_id INT DEFAULT NULL, CHANGE typeprojet_id typeprojet_id INT DEFAULT NULL, CHANGE adress_id adress_id INT DEFAULT NULL, CHANGE place1 place1 VARCHAR(100) CHARACTER SET utf8 DEFAULT \'\'\'draft\'\'\' NOT NULL COLLATE `utf8_unicode_ci`, CHANGE datedevis datedevis DATE DEFAULT \'NULL\', CHANGE datefacture datefacture DATE DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE type_projet DROP contientsuraface, DROP priseencharge, CHANGE familleprojet_id familleprojet_id INT DEFAULT NULL');
