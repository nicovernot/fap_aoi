 ...
 */
final class Version20200617180212 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE document CHANGE user_id user_id INT DEFAULT NULL, CHANGE conditionplace_id conditionplace_id INT DEFAULT NULL, CHANGE projet_id projet_id INT DEFAULT NULL, CHANGE fichier fichier VARCHAR(400) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE condition_place CHANGE place_id place_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE document CHANGE user_id user_id INT DEFAULT NULL, CHANGE conditionplace_id conditionplace_id INT DEFAULT NULL, CHANGE projet_id projet_id INT DEFAULT NULL, CHANGE fichier fichier VARCHAR(250) CHARACTER SET utf8 DEFAULT \'NULL\' COLLATE `utf8_unicode_ci`');
