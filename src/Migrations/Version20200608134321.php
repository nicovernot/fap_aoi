 ...
 */
final class Version20200608134321 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE taille_surface (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, min INT NOT NULL, max INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE taille_surface');
        $this->addSql('ALTER TABLE adress CHANGE user_id user_id INT DEFAULT NULL');
