 ...
 */
final class Version20200611091711 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message ADD destinataire_id INT DEFAULT NULL, CHANGE projet_id projet_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307FA4F84F6E FOREIGN KEY (destinataire_id) REFERENCES `user1` (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message DROP destinataire_id, CHANGE projet_id projet_id INT DEFAULT NULL');
