 ...
 */
final class Version20200613080716 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE place CHANGE typeprojet_id typeprojet_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE projet CHANGE projectadmin_id projectadmin_id INT DEFAULT NULL, CHANGE typeprojet_id typeprojet_id INT DEFAULT NULL, CHANGE adress_id adress_id INT DEFAULT NULL, CHANGE place place VARCHAR(100) CHARACTER SET utf8 DEFAULT \'\'\'foo bar\'\'\' COLLATE `utf8_unicode_ci`, CHANGE datedevis datedevis DATE DEFAULT \'NULL\', CHANGE datefacture datefacture DATE DEFAULT \'NULL\'');
