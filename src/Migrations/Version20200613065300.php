 ...
 */
final class Version20200613065300 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE projet CHANGE projectadmin_id projectadmin_id INT DEFAULT NULL, CHANGE typeprojet_id typeprojet_id INT DEFAULT NULL, CHANGE adress_id adress_id INT DEFAULT NULL, CHANGE datedevis datedevis DATE DEFAULT NULL, CHANGE datefacture datefacture DATE DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE message ADD sent TINYINT(1) NOT NULL, CHANGE projet_id projet_id INT DEFAULT NULL, CHANGE destinataire_id destinataire_id INT DEFAULT NULL, CHANGE emeteur_id emeteur_id INT DEFAULT NULL, CHANGE typemessage_id typemessage_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message DROP sent, CHANGE projet_id projet_id INT DEFAULT NULL, CHANGE destinataire_id destinataire_id INT DEFAULT NULL, CHANGE emeteur_id emeteur_id INT DEFAULT NULL, CHANGE typemessage_id typemessage_id INT DEFAULT NULL');
