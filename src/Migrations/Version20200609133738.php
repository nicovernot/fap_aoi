 ...
 */
final class Version20200609133738 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adress CHANGE user_id user_id INT DEFAULT NULL, CHANGE energie_id energie_id INT DEFAULT NULL');
