 ...
 */
final class Version20190629034227 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE menu (id INT NOT NULL, appli_id INT DEFAULT NULL, mencod VARCHAR(255) DEFAULT NULL, menlib VARCHAR(255) DEFAULT NULL, menord INT DEFAULT NULL, mencom VARCHAR(255) DEFAULT NULL, mendat TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, menphp VARCHAR(255) DEFAULT NULL, mensql VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE type_message_message (type_message_id INT NOT NULL, message_id INT NOT NULL, PRIMARY KEY(type_message_id, message_id))');
        $this->addSql('CREATE INDEX IDX_D1019E074E79C50C ON type_message_message (type_message_id)');
        $this->addSql('CREATE INDEX IDX_D1019E07537A1329 ON type_message_message (message_id)');
        $this->addSql('CREATE TABLE "user1" (id INT NOT NULL, appli_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, tel VARCHAR(255) NOT NULL, date_naissance TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, lieu_naissance VARCHAR(255) NOT NULL, rue VARCHAR(255) NOT NULL, numero_rue INT NOT NULL, ville VARCHAR(255) NOT NULL, codepostal INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE paiement (id INT NOT NULL, client_id INT NOT NULL, abonnement_id INT NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, idpaiement VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_B1DC7A1E19EB6921 ON paiement (client_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B1DC7A1EF1D74413 ON paiement (abonnement_id)');
        $this->addSql('CREATE TABLE message (id INT NOT NULL, message TEXT NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE abonnement (id INT NOT NULL, client_id INT NOT NULL, magazine_id INT NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, encours BOOLEAN DEFAULT NULL, remboursement BOOLEAN DEFAULT NULL, dateremboursement TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, estpaye BOOLEAN DEFAULT NULL, estprolonge BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE type_message_message ADD CONSTRAINT FK_D1019E074E79C50C FOREIGN KEY (type_message_id) REFERENCES type_message (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE type_message_message ADD CONSTRAINT FK_D1019E07537A1329 FOREIGN KEY (message_id) REFERENCES message (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE paiement ADD CONSTRAINT FK_B1DC7A1E19EB6921 FOREIGN KEY (client_id) REFERENCES "user1" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE paiement ADD CONSTRAINT FK_B1DC7A1EF1D74413 FOREIGN KEY (abonnement_id) REFERENCES abonnement (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type_message_message DROP CONSTRAINT FK_D1019E074E79C50C');
        ...
        $this->addSql('ALTER TABLE type_message_message DROP CONSTRAINT FK_D1019E07537A1329');
        $this->addSql('ALTER TABLE message_user DROP CONSTRAINT FK_24064D90537A1329');
        $this->addSql('ALTER TABLE paiement DROP CONSTRAINT FK_B1DC7A1EF1D74413');
