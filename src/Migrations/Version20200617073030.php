 ...
 */
final class Version20200617073030 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE condition_place ADD typedocument VARCHAR(150) NOT NULL, CHANGE place_id place_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE condition_place DROP typedocument, CHANGE place_id place_id INT DEFAULT NULL');
