 ...
 */
final class Version20200611114332 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message ADD emeteur_id INT DEFAULT NULL, ADD typemessage_id INT DEFAULT NULL, CHANGE projet_id projet_id INT DEFAULT NULL, CHANGE destinataire_id destinataire_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307FC8791E35 FOREIGN KEY (emeteur_id) REFERENCES `user1` (id)');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307FAA20F324 FOREIGN KEY (typemessage_id) REFERENCES type_message (id)');
        $this->addSql('CREATE INDEX IDX_B6BD307FC8791E35 ON message (emeteur_id)');
        $this->addSql('CREATE INDEX IDX_B6BD307FAA20F324 ON message (typemessage_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE message_user (message_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_24064D90A76ED395 (user_id), INDEX IDX_24064D90537A1329 (message_id), PRIMARY KEY(message_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE message DROP FOREIGN KEY FK_B6BD307FC8791E35');
        $this->addSql('ALTER TABLE message DROP FOREIGN KEY FK_B6BD307FAA20F324');
        $this->addSql('DROP INDEX IDX_B6BD307FC8791E35 ON message');
        $this->addSql('DROP INDEX IDX_B6BD307FAA20F324 ON message');
        $this->addSql('ALTER TABLE message DROP emeteur_id, DROP typemessage_id, CHANGE projet_id projet_id INT DEFAULT NULL, CHANGE destinataire_id destinataire_id INT DEFAULT NULL');
