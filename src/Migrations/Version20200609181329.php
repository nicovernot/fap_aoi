 ...
 */
final class Version20200609181329 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type_projet ADD familleprojet_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE type_projet ADD CONSTRAINT FK_73C2F791697F6267 FOREIGN KEY (familleprojet_id) REFERENCES famille_projet (id)');
        $this->addSql('CREATE INDEX IDX_73C2F791697F6267 ON type_projet (familleprojet_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type_projet DROP FOREIGN KEY FK_73C2F791697F6267');
        $this->addSql('DROP INDEX IDX_73C2F791697F6267 ON type_projet');
        $this->addSql('ALTER TABLE type_projet DROP familleprojet_id');
