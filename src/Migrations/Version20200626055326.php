 ...
 */
final class Version20200626055326 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type_projet ADD plafondbool TINYINT(1) NOT NULL, ADD montantplafond DOUBLE PRECISION NOT NULL, CHANGE familleprojet_id familleprojet_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type_projet DROP plafondbool, DROP montantplafond, CHANGE familleprojet_id familleprojet_id INT DEFAULT NULL');
