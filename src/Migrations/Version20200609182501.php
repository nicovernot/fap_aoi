 ...
 */
final class Version20200609182501 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type_projet CHANGE familleprojet_id familleprojet_id INT DEFAULT NULL, CHANGE description description VARCHAR(600) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type_projet CHANGE familleprojet_id familleprojet_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`');
